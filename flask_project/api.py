...
import json
from db import get_weather, get_crimes
...
def api_search_weather():
    # DEFAULT_WEATHER_PER_PAGE = 20

    weather = get_weather(
        # None, page=0, weather_per_page=DEFAULT_WEATHER_PER_PAGE)
    )
    ...
    response = {
        ...
        "weather": weather,
        # "page": 0,
        # "entries_per_page": DEFAULT_WEATHER_PER_PAGE,
